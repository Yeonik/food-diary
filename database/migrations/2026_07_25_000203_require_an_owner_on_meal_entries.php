...
/**
 * Step C of three, for `meal_entries`: the constraint.
 *
...
return new class extends Migration
{
    ...
    {
        $orphans = DB::table('meal_entries')->whereNull('user_id')->count();
        ...
        if ($orphans > 0) {
            ...
            throw new RuntimeException(
                "Cannot require an owner on meal_entries: {$orphans} rows still have none. ".
