...
/**
 * Step C of three, for `food_item_aliases`: the constraint.
 *
...
return new class extends Migration
{
    ...
    {
        $orphans = DB::table('food_item_aliases')->whereNull('user_id')->count();
        ...
        if ($orphans > 0) {
            ...
            throw new RuntimeException(
                "Cannot require an owner on food_item_aliases: {$orphans} rows still have none. ".
