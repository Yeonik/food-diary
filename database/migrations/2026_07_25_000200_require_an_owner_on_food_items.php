...
/**
 * Step C of three, for `food_items`: the constraint.
 *
...
return new class extends Migration
{
    ...
    {
        $orphans = DB::table('food_items')->whereNull('user_id')->count();
        ...
        if ($orphans > 0) {
            ...
            throw new RuntimeException(
                "Cannot require an owner on food_items: {$orphans} rows still have none. ".
